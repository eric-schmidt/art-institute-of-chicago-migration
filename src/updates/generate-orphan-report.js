...
// Object to hold candidates for deletion. Includes a header since this
// will be exported to CSV later on.
const orphans = ["Orphan Entry Links"];

const logOrphans = async (type) => {
  ...
  createCSV(orphans, `${type}Orphans.csv`);
};
